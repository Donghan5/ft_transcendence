...
53. 일단 토너먼트 생성 후 DB에 토너먼트 정보를 잘 저장함. 하지만 토너먼트 친구초대 기능 + active tournament 에 아무런 토너먼트 목록도 없음

54. 화면 리프레쉬시 토너먼트 정보가 다 날아감 (리프레쉬 되면서 메모리도 같이 날아가는 듯)

55. 여기서 조인 버튼은 active tournament 와 함께 놔두기. 해당 토너먼트에 참가할 수 있게 함.
